/* Faça um algoritmo que receba o nome de dois jogadores e após isso peça 5 números de 1 a 10 para cada jogador. Primeiro para o jogador A e depois para o Jogador B.
Após a escolha de cada jogador o algoritmo deve apresentar quais forma os números iguais que o jogador A e B colocaram.
...
//Condição para números iguais entre os jogadores A e B                        
                        if(first_array[i]==second_array[j])
                        {
                            iguais.push(first_array[i])
                        }
                    }
                }

//Impressão do resultado                
                console.log(`Os números iguais entre ${jogador1} e ${jogador2} são:`, iguais)
                interface.close()
            })
        })
    })
